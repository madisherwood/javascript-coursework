let age = 19;
let fullName = "Madilynn Sherwood";
let isEnrolled = true; 
let futureGoal; // run a marathon
let incompletedCourse = null; // Javascript Mode
...
console.log("incompleted Course:", incompletedCourse, "Type:", typeof incompletedCourse);
let ageAsString = String(age);
console.log("Original:", age, typeod age, "| Converted:", ageAsString, typeof ageAsString);
